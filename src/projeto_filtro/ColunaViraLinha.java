 ...
 */
public class ColunaViraLinha extends javax.swing.JFrame {
    ...
    private void btnVisualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVisualizarActionPerformed
        // TODO add your handling code here:
        imgProcessada = filtro.colunaViraLinha(imgOriginal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ColunaViraLinha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ColunaViraLinha().setVisible(true);
            }
        });
    }
